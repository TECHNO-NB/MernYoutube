...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`fixed ${open ? "left-[-14em]" : "left-[0em]" } bg-none transition-all z-20 bg-gray-800 w-[55vw]  h-[100vh] border-r-2 border-white md:left-[0em] md:w-[17vw] md:h-[100vh]`}
      >
        <div className=" flex flex-col items-center text-center gap-[7px] border-x-5 border-red-400 ">
          <div  onClick={()=>{handleNavigate("/")}} className="flex items-center py-[5px] mt-0 rounded-sm text-white border-2 w-[95%]  gap-4 text-[1.2em] cursor-pointer hover:bg-purple-800 ">
 ...
 {/* sideBar Bottom Part */}
       <div className="flex flex-col mt-[151%] items-center gap-2 md:mt-[105%]">
          {/* For Pic */}
