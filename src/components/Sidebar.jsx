...
const Sidebar = ({open}) => {
 return (
    <>
    <div className={`fixed ${open.modal ? "left-0" : "left-[-16.5em]"} bg-none transition-all z-20 bg-gray-800 w-[55vw] h-[119vh] border-r-2 border-white md:left-[0em] md:w-[17vw] md:h-[100vh]`}>
